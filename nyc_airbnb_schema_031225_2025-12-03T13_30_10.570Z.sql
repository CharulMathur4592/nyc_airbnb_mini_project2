CREATE TABLE IF NOT EXISTS `host_df` (
	`neighbourhood_id` INT NOT NULL UNIQUE,
...
ADD FOREIGN KEY(`neighbourhood_id`) REFERENCES `host_df`(`neighbourhood_id`)
ON UPDATE NO ACTION ON DELETE NO ACTION;
ALTER TABLE `neighbourhood_df`
ADD FOREIGN KEY(`neighbourhood_id`) REFERENCES `listing_df`(`neighbourhood_id`)
ON UPDATE NO ACTION ON DELETE NO ACTION;